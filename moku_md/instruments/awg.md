---
date: 2025-11-17
path_to_py_file: moku/instruments/_awg.py
...
- `set_frontend(channel, impedance, coupling, range, bandwidth=None, strict)` - Configure input frontend parameters
...
- Controls input impedance (1MOhm/50Ohm), coupling (AC/DC), range (100mVpp to 50Vpp), and bandwidth (1MHz to 2GHz)
