---
date: 2025-11-17
path_to_py_file: moku/instruments/_waveformgenerator.py
...
- `set_frontend(channel, impedance, coupling, range, bandwidth)` - Configure input frontend settings
...
```python
def set_frontend(channel, impedance, coupling, range, bandwidth=None, strict=True):
