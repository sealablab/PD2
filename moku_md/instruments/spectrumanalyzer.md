---
date: 2025-11-17
path_to_py_file: moku/instruments/_spectrumanalyzer.py
...
- `set_frontend(channel, impedance, coupling, range, bandwidth=None, strict=True)` - Configure input channel frontend settings
