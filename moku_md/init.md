...
type: reference
date: 2025-11-17
path_to_py_file: moku/__init__.py
title: moku
tags:
  - moku
  - api
...
- `claim_ownership(force_connect=True, force_deploy=False, ignore_busy=False, persist_state=False)` - Claim exclusive ownership of the device
...
---
**View this document:**
- 📖 [Obsidian Publish](https://publish.obsidian.md/dpd-001/moku_md/__init__)
- 💻 [GitHub](https://github.com/sealablab/DPD-001/blob/main/moku_md/__init__.md)
- ✏️ [Edit on GitHub](https://github.com/sealablab/DPD-001/edit/main/moku_md/__init__.md)
